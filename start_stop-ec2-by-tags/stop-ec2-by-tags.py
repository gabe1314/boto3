...
np_sers_ids=[]
f1={"Name": "tag:Name", "Values":['AWS_Admin_Bastion']}
...
print("Stopping intances with ids of : ",np_sers_ids)
ec2_con_cli.stop_instances(InstanceIds=np_sers_ids)
waiter=ec2_con_cli.get_waiter('instance_stopped')
waiter.wait(InstanceIds=np_sers_ids)
print("Your np instances is stopping now....")